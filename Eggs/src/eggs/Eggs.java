...
public class Eggs 
{
	...
	public static void main(String[] args) 
	{
		...
		JOptionPane.showMessageDialog(null, "You ordered " + totalOfEggsOrdered + " eggs. That's " + numberOfDozenEggs + " dozen at $" + dozenEggsCost + " per dozen and " + remainderEgg +
				" loose eggs at " + remainderEggCost + " cents each for a total of $" + totalCost);
